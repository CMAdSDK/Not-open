...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    navigationController.navigationBar.barTintColor = [UIColor defaultCarbonariusColor];
    ...
    self.window.backgroundColor = [UIColor defaultLightGrayColor];
